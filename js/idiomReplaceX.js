...
(function(document, window, undefined) {
  ...
  bindTo.idiomReplaceX.ui = function(baseURL) {
    ...
    bar.innerHTML = '<section><div id="idiomreplacex-logo-container" class="logo-container"><img class="irx-logo" src="' + baseURL + '/image/irx-logo.png" /></div><div class="form-container">' +
